...
function App() {
  ...
  <span className="text-2xl sm:text-3xl font-bold text-orange-600">TaxZoom</span>
          ...
          <nav className="space-x-6 hidden md:flex">
            ...
            <Link to="/services" className="text-gray-700 hover:text-blue-600 font-medium">ITRFiling</Link>
            <Link to="/gst-filing" className="text-gray-700 hover:text-blue-600 font-medium">GST Filing</Link>
